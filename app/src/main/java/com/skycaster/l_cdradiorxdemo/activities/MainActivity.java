...
public class MainActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        freq=Double.parseDouble(mSp.getString(StaticData.FREQ, "98"));
        toneLeft=mSp.getInt(StaticData.LEFT_TUNE, 36);
        toneRight=mSp.getInt(StaticData.RIGHT_TUNE, 45);
            ...
            public void onClick(View v) {
                ...
                try {
                    if (dspManager.apiOpenCDRadio(freq, toneLeft, toneRight)) {
                        ...
                        edit.putString(StaticData.FREQ,s_freq);
        ...
        tgbtn_startBiz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (tgbtn_startBiz.isChecked()) {
                    boolean isSuccess = dspManager.apiGetService(MainActivity.this, 88, (byte) 33, new BusinessDataListener() {
                        @Override
                        public void preTask() {
                            bizDataList.clear();
        ...
        tgbtn_startTuner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (tgbtn_startTuner.isChecked()) {
                    ...
                    boolean isSuccess = dspManager.apiOpenDAQ(MainActivity.this, tunerDataListener);
                    if (!isSuccess) {
                        tgbtn_startTuner.setChecked(false);
                    }
                } else {
